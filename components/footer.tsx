        ...
        <div className="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
          <div className="flex items-center space-x-4 mx-auto justify-center">
            <Image
              ...
              height={48}
            />
            <h2 className="font-display text-2xl">{siteConfig.global.name}</h2>
          </div>
          <ul
            role="list"
          ...
          <div className="m-auto flex w-max items-center justify-between space-x-4">
            <a href="mailto:wanjun@chainport.pro" aria-label="send mail">
              <svg
            ...
            {/* phone */}
            <a href="https://github.com/Chain-Port" aria-label="github">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          <div className="text-center">
            <span className="text-sm tracking-wide">
              Copyright © Chain Port LLC <span id="year">2024</span> | All right
              reserved
            </span>
          </div>
          <div className="flex space-x-2 justify-center items-center">
            <a className="text-xs tracking-wide" href="/privacy-policy">
              Privacy Policy
            </a>
            ...
            <a className="text-xs tracking-wide" href="/terms-of-service">
              Terms of Service
            </a>
          </div>
        </div>
